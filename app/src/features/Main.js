              ...
              <div className="card">
                  ...
                  <div className="card-content">
                      <div className="card-body">
                          <p className="card-text">Add <code>.table-bordered</code> for borders on all sides of the table
                              and
                              cells. For
      ...
      <div className="row" id="table-borderless">
          <div className="col-12">
              <div className="card">
                  ...
                  <div className="card-content">
                      <div className="card-body">
                          <p className="card-text">Add <code>.table-borderless</code> for a table without borders. It can
                              also
                              be used on
                              dark tables.</p>
                      </div>
      ...
      <div className="row" id="table-hover-row">
          <div className="col-12">
              <div className="card">
                  ...
                  <div className="card-content">
                      <div className="card-body">
                          <p>Add <code className="highlighter-rouge">.table-hover</code> to enable a hover state on table
                              rows
                              within a
                  ...
                  <div className="card-content">
                      <div className="card-body">
                          <p>Responsive tables allow tables to be scrolled horizontally with ease. Make any table
                              ...
                              viewports by adding a div with the class <code className="highlighter-rouge">.table-responsive</code>
              around the table. Or, pick a maximum breakpoint with which to have a responsive
                              table up to by adding <code
                                  className="highlighter-rouge"> .table-responsive -sm|-md|-lg|-xl</code>. Read full
                              documentation <a
                          ...
                          <div className="alert alert-primary">
                              <h4 className="alert-heading">Vertical clipping/truncation</h4>
                              <p>Responsive tables make use of <code
                                      className="highlighter-rouge">overflow-y: hidden</code>,
                                  which clips off
